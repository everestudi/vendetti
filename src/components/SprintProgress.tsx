...
export const SPRINTS: Sprint[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Rita — pick list inteligente + comunicação com Weverton/Luís (3 tools)', done: true },
      { label: 'Rita — cadastro/swap/abastecimento direto no Vendtef (UI mapeada parcial — pick list cobre necessidade)', done: false },
