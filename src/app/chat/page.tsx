...
export default function ChatPage() {
  ...
  return (
    <main className="mx-auto flex h-[calc(100vh-3.5rem)] max-w-3xl flex-col px-4 py-4">
        ...
        {messages.length === 0 && (
          <div className="rounded-lg bg-navy-50 p-4 text-sm text-navy/65">
            ...
            <ul className="mt-2 list-disc pl-5 text-xs">
              <li>"Quais slots tão críticos agora?"</li>
              <li>"Qual o produto com pior margem?"</li>
              <li>"Como tá o estoque da máquina?"</li>
              <li>"Detalhe do slot 13"</li>
              <li>"Últimas decisões"</li>
            </ul>
          </div>
        )}
            ...
            return (
              <div key={i} className="my-1.5 rounded border border-gold/40 bg-gold-50 px-2 py-1 text-xs text-navy/70">
                ...
                {p.state === 'input-available' && (
                  <div className="text-navy/50">chamando...</div>
                )}
